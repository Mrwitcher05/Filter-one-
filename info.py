...
auth_channel = environ.get('AUTH_CHANNEL', '-1002435587008') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request File With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002340370364')
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/cinemacityhub2025')
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'e9705a6c7a50b0a63ed749abe6d6711dc97c40df')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/howtodownload_naruto')
